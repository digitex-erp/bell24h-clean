      ...
      indexOf(e, r = null, n = 'utf-8', i = !1) {
        ...
        return (
          ...
          s.length === 0 && i === !1
            ...
            : o(
                (f, h) =>
                  (i ? h <= a : h >= a) && this[h] === s[0] && s.every((C, k) => this[h + k] === C)
              )
        );
      }
...
function ia(t, e) {
  ...
  r && (r.getField(t.firstField)?.markAsError(), r.getField(t.secondField)?.markAsError()),
    e.addErrorMessage(
      n =>
        `Please ${n.bold('either')} use ${n.green(`\`${t.firstField}\``)} or ${n.green(
          `\`${t.secondField}\``
...
function la(t, e) {
  ...
  n && (n.removeAllFields(), gi(n, r)),
    e.addErrorMessage(o =>
      i
        ? `The ${o.red('`select`')} statement for type ${o.bold(r.name)} must not be empty. ${ft(
            o
          )}`
