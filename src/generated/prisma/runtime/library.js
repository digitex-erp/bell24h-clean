...
function Ti(e) {
  let r = e.e,
    ...
    i = `Please refer to the documentation about Prisma's system requirements: ${bi(
...
function gp(e, r, t) {
  ...
  if (n && r && i && sn.default.existsSync(r)) {
    ...
    if (s.length > 0) {
      ...
      if (t === 'error') {
        let u = `There is a conflict between env var${s.length > 1 ? 's' : ''} in ${Y(a)} and ${Y(
          l
        )}
...
m.toFraction = function (e) {
  ...
  return (
    ...
    (t = t.plus(i.times(n))),
    (l.s = u.s = f.s),
    (d = L(u, n, o, 1).minus(f).abs().cmp(L(l, t, o, 1).minus(f).abs()) < 1 ? [u, n] : [l, t]),
    (h.precision = c),
    (w = !0),
    d
  );
...
function Dd(e, r) {
  ...
  n && (n.removeAllFields(), ga(n, t)),
    r.addErrorMessage(o =>
      i
        ? `The ${o.red('`select`')} statement for type ${o.bold(t.name)} must not be empty. ${dt(
            o
          )}`
        : `The ${o.red('`select`')} statement for type ${o.bold(t.name)} needs ${o.bold(
...
function qd(e, r) {
  ...
  n && n.getDeepFieldValue(e.argumentPath)?.markAsError(),
    r.addErrorMessage(i => {
      ...
      return `Argument \`${i.bold(t)}\`: Invalid value provided. Expected ${o}, provided ${i.red(
        e.inferredType
      )}.`;
    });
}
    ...
    async withRetry(r) {
      for (let t = 0; ; t++) {
        ...
        try {
          ...
          this.logEmitter.emit('warn', {
            message: `Attempt ${t + 1}/${Dl} failed for ${r.actionGerund}: ${
              i.message ?? '(unknown)'
            }`,
            timestamp: new Date(),
            target: '',
  ...
  async getCurrentBinaryTarget() {
    {
      ...
      if (!Ml.includes(r))
        throw new T(
          `Unknown ${ce('PRISMA_QUERY_ENGINE_LIBRARY')} ${ce(W(r))}. Possible binaryTargets: ${qe(
            Ml.join(', ')
